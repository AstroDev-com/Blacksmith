    ...
    <nav class="sidebar-menu">
        ...
        <div class="menu-item has-submenu">
            <div class="menu-item-left">
                ...
                <span><?php echo e(__('dashboard.trips_management', ['fallback' => 'Trips Management'])); ?></span>
            </div>
        ...
        <div class="submenu">
            <a href="<?php echo e(route('admin.trips.index')); ?>" class="menu-item">
                <div class="menu-item-left">
                    <i class="fas fa-list text-success"></i>
                    <span><?php echo e(__('dashboard.trips_list')); ?></span>
                </div>
            </a>
            <a href="<?php echo e(route('admin.trips.create')); ?>" class="menu-item">
                <div class="menu-item-left">
                    <i class="fas fa-plus text-success"></i>
                    <span><?php echo e(__('dashboard.add_trip')); ?></span>
                </div>
            </a>
            <a href="<?php echo e(route('admin.activity.index')); ?>" class="menu-item">
                <div class="menu-item-left">
                    <i class="fas fa-fw fa-history"></i>
                    <span><?php echo e(__('dashboard.activity_log', ['fallback' => 'Activity Log'])); ?></span>
                </div>
            </a>
            
            <a href="<?php echo e(route('admin.expense-categories.index')); ?>" class="menu-item">
                <div class="menu-item-left">
                    <i class="fas fa-tags text-info"></i>
                    <span><?php echo e(__('dashboard.expense_categories', ['fallback' => 'Expense Categories'])); ?></span>
                </div>
            </a>
        </div>
        ...
        <div class="menu-item has-submenu">
            <div class="menu-item-left">
                ...
                <span><?php echo e(__('dashboard.reports', ['fallback' => 'Reports'])); ?></span>
            </div>
        </div>
        <div class="submenu">
            <a href="<?php echo e(route('admin.reports.index')); ?>" class="menu-item">
                <div class="menu-item-left">
                    <i class="fas fa-list text-success"></i>
                    <span><?php echo e(__('dashboard.reports_list', ['fallback' => 'Reports List'])); ?></span>
                </div>
            </a>
        </div>
        ...
        <div class="menu-item has-submenu">
            <div class="menu-item-left">
                ...
                <span><?php echo e(__('dashboard.users')); ?></span>
            </div>
            <?php if(LaravelLocalization::getCurrentLocale() == 'ar'): ?>
                <i class="fas fa-chevron-left"></i>
            <?php else: ?>
        ...
        <div class="submenu">
            <a href=" <?php echo e(route('users.index')); ?>" class="menu-item">
                <div class="menu-item-left">
                    ...
                    <span><?php echo e(__('dashboard.users_list')); ?></span>
                </div>
            </a>
            <!-- User Profile Link -->
            <a href="<?php echo e(route('user.profile.edit')); ?>" class="menu-item">
                <div class="menu-item-left">
                    ...
                    <span><?php echo e(__('dashboard.edit_profile')); ?></span>
                </div>
            </a>
            ...
            <a href="<?php echo e(route('users.trashed')); ?>" class="menu-item">
                <div class="menu-item-left">
                    ...
                    <span><?php echo e(__('dashboard.deleted_users')); ?></span>
                    <span
...
<?php /**PATH C:\xampp\htdocs\My_laravel\‏‏laravel_2025_trips\resources\views/admin/includes/sidebar.blade.php ENDPATH**/ ?>