<?php $__env->startSection('content'); ?>
    <div class="container">
        ...
        <div class="card" style="width: 24rem;">
            <img src="<?php echo e(asset('images/' . $category->image)); ?>" class="card-img-top" alt="<?php echo e($category->name); ?>" style="max-width: 100%; height: auto;">
            <div class="card-body">
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\All My Project\My father Work\0- template_dashboard\resources\views/admin/categories/show.blade.php ENDPATH**/ ?>