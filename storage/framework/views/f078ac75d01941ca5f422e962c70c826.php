    ...
    <script>
        function previewFile(event) {
            ...
            if (input.files && input.files[0]) {
                ...
                preview.src =
                    "<?php echo e($user->thumbnail ? asset('admin/uploads/users/thumbnails/' . $user->thumbnail) : asset('admin/assets/img/emp_default.png')); ?>";
            }
        }
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\My_laravel\‏‏‏‏laravel_2025_clinic\resources\views/admin/role-permission/user/edit.blade.php ENDPATH**/ ?>