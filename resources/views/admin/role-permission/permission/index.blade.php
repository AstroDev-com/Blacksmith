                ...
                <div class="card permissions-list-card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                <h3 class="card-title mb-0">{{ __('dashboard.permissions_list') }}</h3>
                                <p class="text-muted mb-0">{{ __('dashboard.manage_permissions') }}</p>
                            </div>
                        </div>
                        <a href="{{ route('permissions.create') }}" class="btn btn-primary add-permission-btn">
                            <i class="fas fa-plus me-2"></i>
                            <span>{{ __('dashboard.add_permission') }}</span>
                        </a>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="col-md-4 col-lg-4">
                                <div class="form-group floating-label mb-0">
                                    <label for="permissionSearchInput" class="form-label">
                                        <i class="fas fa-search"></i> {{ __('dashboard.search_permissions') }}
                                    </label>
                            ...
                            <table class="table table-hover permissions-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center"><i class="fas fa-key me-1"></i>{{ __('dashboard.name') }}
                                        </th>
                                        <th class="text-center"><i
                                                class="fas fa-users me-1"></i>{{ __('dashboard.roles_count') }}</th>
                                        <th class="text-center"><i
                                                class="fas fa-toggle-on me-1"></i>{{ __('dashboard.status') }}</th>
                                        <th class="text-center"><i
                                                class="fas fa-calendar me-1"></i>{{ __('dashboard.created_at') }}</th>
                                        <th class="text-center"><i
                                                class="fas fa-cogs me-1"></i>{{ __('dashboard.actions') }}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <tr>
                                            <td colspan="5" class="text-center py-5">
                                                <div class="empty-state">
                                                    ...
                                                    <h4>{{ __('dashboard.no_permissions_found') }}</h4>
                                                    <p class="text-muted">
                                                        {{ __('dashboard.add_new_permission_to_get_started') }}</p>
                                                    <a href="{{ route('permissions.create') }}"
                                                        class="btn btn-primary mt-3">
                                                        <i class="fas fa-plus me-2"></i>
                                                        {{ __('dashboard.add_permission') }}
                                                    </a>
                                                </div>
                                            </td>
                                        </tr>
                        ...
                        @if ($permissions->count() > 0)
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="text-muted">
                                    ...
                                    {{ __('dashboard.showing') }} {{ $permissions->count() }}
                                    {{ __('dashboard.permissions') }}
                                </div>
                                <div class="pagination-info">
                                    <span class="badge bg-primary">
                                        <i class="fas fa-database me-1"></i>
                                        {{ __('dashboard.total_permissions') }}: {{ $permissions->count() }}
                                    </span>
                                </div>
                            </div>
                        @endif
                    ...
                    <tr>
                        <td colspan="6" class="text-center py-5">
                            <div class="empty-state">
                                ...
                                <p class="text-muted">
                                    {{ __('dashboard.no_permissions_found') }}
                                </p>
            ...
            const applyFilters = function() {
                ...
                if (footerCount) {
                    footerCount.innerHTML =
                        `<i class="fas fa-info-circle me-1"></i> ${filteredRows.length} {{ __('dashboard.permissions') }}`;
                }
            };
