...
@section('content')
                                                ...
                                                <div
                                                        ...
                                                        <div class="input-group input-group-sm">
                                                            ...
                                                            @if ($setting->type == 'text')
                                                                <input type="text" class="form-control form-control-sm"
                                                                    ...
                                                                    value="{{ $setting->value }}" required placeholder=" ">
                                                            @elseif($setting->type == 'textarea')
                                                                <textarea class="form-control form-control-sm" id="{{ $setting->key }}" name="{{ $setting->key }}" rows="2"
                                                                    required placeholder=" ">{{ $setting->value }}</textarea>
                                                            @endif
                                                            <label for="{{ $setting->key }}"
                                                                class="form-label fw-bold text-info">{{ $setting->description }}</label>
                                                        </div>
                                                    ...
                                                    @elseif($setting->type == 'image')
                                                        <label class="form-label fw-bold text-info d-block mb-2">
                                                            <i class="fas fa-image me-1"></i> {{ $setting->description }}
                                                        </label>
                                                        <div class="image-upload-container mx-auto"
                                                            style="max-width: 100%;">
                                                            <div class="image-upload-wrapper setting-image-upload-wrapper"
                                                                data-input-id="{{ $setting->key }}">
                                                                <input type="file" name="{{ $setting->key }}"
                                                                    id="{{ $setting->key }}"
                                                                    class="form-control setting-image-input visually-hidden @error($setting->key) is-invalid @enderror"
                                                                    accept="image/*">

                                                                <div
                                                                    class="upload-placeholder {{ $setting->value ? 'd-none' : '' }}">
                                                                    <div class="upload-icon">
                                                                        <i class="fas fa-cloud-upload-alt"></i>
                                                                    </div>
                                                                    <div class="upload-text">
                                                                        <span
                                                                            class="upload-title">{{ __('dashboard.choose_image', ['fallback' => 'Choose Image']) }}</span>
                                                                        <span
                                                                            class="upload-subtitle">{{ __('dashboard.drag_drop_here', ['fallback' => 'Or drag and drop image here']) }}</span>
                                                                    </div>
                                                                </div>

                                                                <div class="image-preview {{ $setting->value ? '' : 'd-none' }}"
                                                                    style="width: 100%; height: 100%;">
                                                                    <div class="preview-container"
                                                                        style="width: 100%; height: 100%;">
                                                                        <img id="{{ $setting->key }}_preview"
                                                                            src="{{ $setting->value ? Storage::url('settings/' . $setting->value) : '#' }}"
                                                                            alt="Preview" class="img-fluid rounded"
                                                                            style="object-fit: contain; width: 100%; height: 100%;">
                                                                        <button type="button"
                                                                            class="remove-image-btn setting-remove-image-btn"
                                                                            title="{{ __('dashboard.remove_image', ['fallback' => 'Remove Image']) }}"
                                                                            data-input-id="{{ $setting->key }}">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="input-group input-group-sm">
                                                                ...
                                                                <input type="{{ $setting->type }}"
                                                                    ...
                                                                    value="{{ $setting->value }}" required placeholder=" ">
                                                                <label for="{{ $setting->key }}"
                                                                    class="form-label fw-bold text-success">{{ $setting->description }}</label>
                                                            </div>
                                                            <div class="invalid-feedback">
                                                                <i class="fas fa-exclamation-triangle me-1"></i>
                                                                هذا الحقل مطلوب
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="input-group input-group-sm">
                                                                ...
                                                                <input type="url" class="form-control form-control-sm"
                                                                    ...
                                                                    placeholder=" ">
                                                                <label for="{{ $setting->key }}"
                                                                    class="form-label fw-bold text-warning">{{ $setting->description }}</label>
                                                            </div>
                                                            <div class="invalid-feedback">
                                                                <i class="fas fa-exclamation-triangle me-1"></i>
                                                                هذا الحقل مطلوب
                                                    ...
                                                    @foreach ($settings['seo'] ?? [] as $setting)
                                                        <div
                                                            ...
                                                            <div class="input-group input-group-sm">
                                                                ...
                                                                @endif
                                                                <label for="{{ $setting->key }}"
                                                                    class="form-label fw-bold text-danger">{{ $setting->description }}</label>
                                                            </div>
                                                            <div class="invalid-feedback">
                                                                <i class="fas fa-exclamation-triangle me-1"></i>
                                                                هذا الحقل مطلوب
    ...
    @push('scripts')
        ...
        {{-- New Image Upload & Preview Script --}}
        <script>
            document.addEventListener('DOMContentLoaded', function() {
